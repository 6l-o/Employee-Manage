...
namespace term3_ali.demo
{
    public partial class sendEmail : System.Web.UI.Page
    {
        ...
        private void InsertContactUs()
        {
            ...
            myPara.Add("@subject",txtSenderEmail.Text);
        ...
        protected void sendEmail2()
        {
            ...
            string rtn = "";
            if (string.IsNullOrEmpty(txtSenderEmail.Text) || string.IsNullOrEmpty(txtBody.Text))
            {
         ...
         //   InsertContactUs(); // to save email in database 
            ...
            {
                myMailMgr.mySubject = txtSenderEmail.Text + " " + senderEmail + ": " + senderName;
        ...
        protected void txtSenderEmail_TextChanged(object sender, EventArgs e)
        {
