...
/// </summary>
/// 
namespace finalyproject.App_Code
{
    ...
    public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["finalyproject"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["finalyproject"].ConnectionString);
        public CRUD()
        {
            //
